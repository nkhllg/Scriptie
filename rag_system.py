...
if os.path.isdir(DATA_FOLDER):
    print(f"The folder '{DATA_FOLDER}' exists and is accessible.")
    
    # List all files in the folder
    files_in_folder = os.listdir(DATA_FOLDER)
    
    if files_in_folder:
        print(f"Documents in '{DATA_FOLDER}':")
        for file in files_in_folder:
            # Optionally check if the file is a text file
            if file.endswith(".txt"):  # or any other type of file you want to check
                print(f"  - {file}")
    else:
        print(f"The folder '{DATA_FOLDER}' is empty.")
else:
    print(f"The folder '{DATA_FOLDER}' does not exist or is not accessible.")
...
if __name__ == "__main__":
    ...
    target_location = "Korea" # Optional: Specify location to filter/focus search
